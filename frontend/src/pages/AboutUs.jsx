...
function AboutUs() {
  ...
  return (
    <div className='px-4 container mx-auto mb-10'>
      ...
      <div className="w-full bg-white border border-yellow-500 rounded-lg shadow-sm">
        <ul className="flex flex-wrap text-sm font-medium text-center text-white bg-yellow-600 rounded-t-lg" role="tablist">
          <li className="me-2">
            <button
              onClick={() => setActiveTab('about')}
              className={`inline-block p-4 rounded-ss-lg transition-all ${activeTab === 'about' ? 'bg-yellow-700' : 'hover:bg-yellow-500'}`}
            >
              About
            </button>
          </li>
          <li className="me-2">
            <button
              ...
              className={`inline-block p-4 transition-all ${activeTab === 'services' ? 'bg-yellow-700' : 'hover:bg-yellow-500'}`}
            >
              Services
            </button>
          </li>
          <li className="me-2">
            <button
              ...
              className={`inline-block p-4 transition-all ${activeTab === 'statistics' ? 'bg-yellow-700' : 'hover:bg-yellow-500'}`}
            >
              Facts
            </button>
          </li>
